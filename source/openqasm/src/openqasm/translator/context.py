...
class _OpenQASMIdentifier:
    ...
    type_val: ty.Optional[ClassicalType]
    name: str
    value: ty.Any
...
class OpenQASMContext:
    ...
    def add_symbol(
        self, type_val: ty.Optional[ClassicalType], symbol: str, value: ty.Any, definition_location: ty.Optional[Span]
    ) -> None:
        ...
        """
        self._symbols[symbol] = _OpenQASMIdentifier(type_val, symbol, value, definition_location)
    ...
    def declare_symbol(self, type_val: ty.Optional[ClassicalType], symbol: str, definition_location: Span) -> None:
        """Declare a symbol without initializing it."""
        self.add_symbol(type_val, symbol, None, definition_location)
